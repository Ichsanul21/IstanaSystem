<x-layouts.admin title="Tambah Workshop">
    <x-slot:header>
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Workshop</h1>
        ...
        <form method="POST" action="{{ route('admin.workshops.store') }}">
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <x-ui.input name="code" label="Kode Workshop" required placeholder="Contoh: WKS-001" />
                    <x-ui.input name="name" label="Nama Workshop" required placeholder="Contoh: Workshop Pusat" />
                </div>
