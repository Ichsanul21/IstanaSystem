...
class ChartOfAccountSeeder extends Seeder
{
    public function run(): void
    {
        $accounts = [
            ...
            ['code' => '1-3000', 'name' => 'Perlengkapan', 'category' => 'asset', 'normal_balance' => 'debit', 'is_active' => true],
            ...
            ['code' => '5-3000', 'name' => 'Beban Listrik & Air', 'category' => 'expense', 'normal_balance' => 'debit', 'is_active' => true],
