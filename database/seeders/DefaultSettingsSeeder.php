...
class DefaultSettingsSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['group' => 'accounting', 'key' => 'inventory_asset_code', 'value' => '1-2000', 'is_public' => false, 'type' => 'string', 'description' => 'Kode akun persediaan'],
            ['group' => 'accounting', 'key' => 'inventory_expense_code', 'value' => '5-2000', 'is_public' => false, 'type' => 'string', 'description' => 'Kode akun beban persediaan'],
